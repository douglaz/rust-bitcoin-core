...
impl PrometheusMetrics {
    ...
    pub fn new() -> Result<Self> {
        Ok(Self {
            // Chain metrics
            chain_height: register_int_gauge!("bitcoin_chain_height", "Current blockchain height")?,
            ...
            p2p_messages_by_type: prometheus::CounterVec::new(
                prometheus::Opts::new("bitcoin_p2p_messages_total", "P2P messages by type"),
            ...
            rpc_requests_total: prometheus::CounterVec::new(
                prometheus::Opts::new("bitcoin_rpc_requests_total", "Total RPC requests by method"),
                &["method", "status"],
            )?,
    ...
    pub fn update_chain_metrics(&self, height: i32, headers: i32, size_bytes: i64, progress: f64) {
    ...
    pub fn update_network_metrics(&self, peers: i64, inbound: i64, outbound: i64) {
    ...
    pub fn update_mempool_metrics(&self, tx_count: i64, size_bytes: i64, min_fee_rate: f64) {
    ...
    pub fn record_transaction_validation(&self, duration_secs: f64, size: usize) {
        ...
        self.transaction_validation_duration_seconds
            .observe(duration_secs);
...
pub async fn start_metrics_collector(
    ...
    loop {
        ...
        // Update network metrics
        {
            ...
            let inbound = peer_info
                .iter()
                .filter(|p| p.get("inbound").and_then(|v| v.as_bool()).unwrap_or(false))
                .count();
            let outbound = peer_info.len() - inbound;
            metrics.update_network_metrics(peer_info.len() as i64, inbound as i64, outbound as i64);
        }
