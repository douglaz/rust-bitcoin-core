...
#[cfg(test)]
mod tests {
    use crate::script::{ScriptInterpreter, ScriptFlags, error::ScriptError};
    use crate::script::signature::SignatureChecker;
    use bitcoin::{Transaction, TxIn, TxOut, OutPoint, Sequence, Amount, Witness};
    use bitcoin::blockdata::script::{ScriptBuf, Builder as ScriptBuilder};
